...
<div class="section__container">
	...
	<div class="keyvisual__template">
		...
		<div class="component__wrap">
			<h2 class="component__title">
				<img src="./img/title02.png" alt="カテゴリ飾り" class="component__title--img">お得情報詳細
			</h2>
		</div>
		<!-- パンくず -->
		<div class="breadcrumb__wrap">
			<p class="breadcrumb__txt">
				<a href="./PageControlFront?pg_id=101">Top</a>/<a href="./PageControlFront?pg_id=113&fr_id=15>">お得情報一覧</a>/<%=r.getReports_name()%>
			</p>
		</div>
	</div>
	...
	<div class="maker__info-wrap">
		...
		<ul>
			<li class="maker__info--list">メーカー名：
			...
			<li class="maker__info--list">メーカーHP：
				<%if(r.getMakers_homepage()==null){ %>
					-
				<%} else{ %>
					<%=r.getMakers_homepage()%>
				<%} %>
			</li>
		</ul>
	</div>
