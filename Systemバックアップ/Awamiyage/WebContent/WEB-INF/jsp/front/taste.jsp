	...
	<div class="keyvisual__template">
		...
		<div class="component__wrap">
			...
			<h2 class="component__title">
				味で探す<img src="./img/title02.png" alt="カテゴリ飾り" class="component__title--img">
			</h2>
	...
	<form action="">
		<div class="radio__wrap">
			<ul class="component__radio">
				...
				<li class="component__radio--list"><input type="radio" name="taste" value="2" class="radio-input" id="radio-02"> <label for="radio-02">辛い</label></li>
				<li class="component__radio--list"><input type="radio" name="taste" value="3" class="radio-input" id="radio-03"> <label for="radio-03">しょっぱい</label></li>
