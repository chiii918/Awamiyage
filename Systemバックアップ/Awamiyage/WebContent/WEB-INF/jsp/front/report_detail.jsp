...
<div class="section__container">
	...
	<div class="keyvisual__template">
		...
		<div class="component__wrap">
			<h2 class="component__title"><img src="./img/title02.png" alt="カテゴリ飾り" class="component__title--img"><%=r.getReports_name()%></h2>
		</div>
	...
	<div class="section__container--report_detail--innner">
		...
		<section class="report_detail--summary">
			...
			<div class="report_detail__evaluation">
				...
				<a href="./PageControlFront?pg_id=113&fr_id=12&pd_id=<%=r.getProducts_id1()%>"><%=r.getProducts_name1()%></a>
			</div>
