...
public class NewsList extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		reports_list = dao.news_list(fr_id);
		...
		if(fr_id==501) {
			...
			request.getRequestDispatcher("WEB-INF/jsp/back/news_list.jsp").forward(request, response);
		}else {
			request.getRequestDispatcher("WEB-INF/jsp/front/news_list.jsp").forward(request, response);
		}
