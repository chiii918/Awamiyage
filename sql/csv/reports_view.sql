...
--
-- Database: postgres
-- Generation Time: 2020-12-16 13:34:27.8120
-- -------------------------------------------------------------
...
CREATE VIEW "public"."reports_view" AS SELECT reports.reports_id,
   ...
   FROM reports
     LEFT JOIN products p1 ON reports.products_id1 = p1.products_id
     LEFT JOIN products p2 ON reports.products_id2 = p2.products_id
     LEFT JOIN products p3 ON reports.products_id3 = p3.products_id
     LEFT JOIN products p4 ON reports.products_id4 = p4.products_id
     LEFT JOIN products p5 ON reports.products_id5 = p5.products_id
     LEFT JOIN makers m1 ON p1.makers_id = m1.makers_id
     LEFT JOIN makers m2 ON p2.makers_id = m2.makers_id
     LEFT JOIN makers m3 ON p3.makers_id = m3.makers_id
     LEFT JOIN makers m4 ON p4.makers_id = m4.makers_id
     LEFT JOIN makers m5 ON p5.makers_id = m5.makers_id
  WHERE reports.reports_type = 1 OR reports.reports_type = 2 AND reports.delete_time IS NULL AND reports.delete_person IS NULL
